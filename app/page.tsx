    ...
    <main className="min-h-screen">
      ...
      <section id="providers" aria-label="Information for Healthcare Providers" className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-8 text-center text-gray-700 dark:text-gray-300">
            Patients can view their test results securely in the{' '}
            <Link href="/auth/signin" className="font-medium text-primary-600 dark:text-primary-400 hover:underline">
              Client Portal
            </Link>.
          </p>
        </div>
      ...
      <section id="contact" aria-label="Contact Information" className="py-20 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-8 text-center text-gray-700 dark:text-gray-300">
            Patients can view their test results in the{' '}
            <Link href="/auth/signin" className="font-medium text-primary-600 dark:text-primary-400 hover:underline">
              Client Portal
            </Link>.
          </p>
